/*
package no.ntnu.stud.minvakt.controller.sms;
...
public class SmsSender implements SmsEventListener
{
    ...
    public SmsSender()
    {
        ...
        sms.setMessage( "Hei! Dette er en testSMS. Din Kode er zxDF56!#0" );
        sms.setRecipient("41354318"); // The recipients phone number.
