...
public class DatabaseConnection {
    ...
    private final String password = TravisUtil.isTravis() ? "" : "c?82dvE5og";
    private final String databasename = TravisUtil.isTravis() ? "jdbc:mysql://localhost/test" : "jdbc:mysql://mysql.stud.ntnu.no/g_scrum02";
